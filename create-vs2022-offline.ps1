# create-vs2022-offline.ps1 -- Part of Hercules-Helper
#
...
# $cmd = "$wget_exe -nc https://aka.ms/vs/17/release/vs_community.exe"
$cmd = "$wget_exe https://aka.ms/vs/17/release/vs_community.exe --output-document=vs_community.exe"
Write-Output $cmd
Invoke-Expression -Command "$cmd"

cmd /c .\vs_community.exe `
    --wait --passive --layout .\vs2022offline --lang en-US `
