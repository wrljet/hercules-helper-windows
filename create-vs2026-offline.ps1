...
# $cmd = "$wget_exe -nc https://aka.ms/vs/18/insiders/vs_Community.exe"
$cmd = "$wget_exe https://aka.ms/vs/18/insiders/vs_Community.exe --output-document=vs_community.exe"
Write-Output $cmd
